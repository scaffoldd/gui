...
This is actually made by https://www.discord.gg/outliershub
I just use this for the custom message? i guess?
So all credits go to .gg/outliershub i guess?
	...
	function handler(player, msg)
		...
		for i, v in next, messages.blacklisted do
			if string.match(msg, i) then
				...
				if autoreport.Advertise == true then (game:GetService("ReplicatedStorage")).DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/w " .. player.Name .. " 😭reported!, i didn't like that😡", "All"); end;
			end;
		end;
